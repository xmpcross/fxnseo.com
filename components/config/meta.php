...
return [
    ...
    */
    ...
    |
    */
	'description' => 'Free browser-based SEO tools and practical guides for improving search visibility, backlinks, content and website performance.',
    ...
    |
    */
	'image' => rtrim(env('APP_URL', 'https://fxnseo.com'), '/') . '/assets/img/logo-light.svg',
