            ...
            <form wire:submit.prevent="onCreateToolTranslation">
                ...
                <div class="card mb-3 cursor-pointer">
                    ...
                    <div class="card-body">
                        ...
                        <span class="text-success text-sm">{{ ( $page_type == 'home' ) ? localization()->getLocalizedURL(app()->getLocale(), route('home') . '/', [], true) : localization()->getLocalizedURL(app()->getLocale(), route('home') . (($page_type == 'post') ? '/blog/' : '/') . $slug, [], true) }}</span>
