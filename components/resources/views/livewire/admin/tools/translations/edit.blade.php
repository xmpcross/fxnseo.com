            ...
            <form wire:submit.prevent="onEditToolTranslation">
                ...
                <div class="card mb-3 cursor-pointer">
                    ...
                    <div class="card-body">
                        ...
                        <span class="text-success text-sm">{{ ( $page_type == 'home' ) ? localization()->getLocalizedURL($locale, route('home') . '/', [], true) : localization()->getLocalizedURL($locale, route('home') . '/' . $slug, [], true) }}</span>
