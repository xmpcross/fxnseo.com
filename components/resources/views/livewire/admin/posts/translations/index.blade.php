                        ...
                        @if ( $page_translations->isNotEmpty() )
                            ...
                            @foreach ($page_translations as $page_translation)
                                ...
                                <tr>
                                    ...
                                    <td class="w-25">
                                        <a href="{{ route('home') . '/' . $page_translation->locale . '/blog/' . $slug }}" class="btn bg-gradient-info mb-0" title="View" target="_blank"><i class="fas fa-eye icon"></i> View</a>
                                        <a href="{{ route('admin.posts.translations.edit', $page_translation->id) }}" class="btn bg-gradient-primary mb-0" title="{{ __('Edit') }}"><i class="fas fa-edit icon"></i> {{ __('Edit') }}</a>
                                        <a wire:click="onDeleteConfirmPostTranslation( {{ $page_translation->id }} )" class="btn bg-gradient-danger mb-0" title="{{ __('Delete') }}"><i class="fas fa-trash icon"></i> {{ __('Delete') }}</a>
                                    </td>
                                </tr>
