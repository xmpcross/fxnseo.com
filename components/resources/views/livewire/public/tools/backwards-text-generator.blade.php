<div>
      ...
      <form wire:submit.prevent="onBackwardsTextGenerator">
        ...
        <div class="form-group position-relative">
            <textarea id="input" class="form-control" wire:model.defer="text" rows="10" placeholder="{{ __('Enter or Paste your content here...') }}" required></textarea>
        ...
        <div class="form-group text-center mb-0">
            <button class="btn bg-gradient-info w-100 w-md-auto mb-1 mb-md-0" wire:loading.attr="disabled">
              <span>
                <div wire:loading.inline wire:target="onBackwardsTextGenerator">
                  <x-loading />
                </div>
                <span wire:target="onBackwardsTextGenerator">{{ __('Generate') }}</span>
              </span>
            </button>
