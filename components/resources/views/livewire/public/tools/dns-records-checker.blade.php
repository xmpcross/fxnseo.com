<div>
      ...
      <form wire:submit.prevent="onDnsRecordsChecker">
        ...
        <div class="form-group mb-3">
            ...
            <div class="col">
                <div class="input-group input-group-flat">
                    <input type="text" id="input" class="form-control" wire:model.defer="domain" placeholder="google.com" required>
        ...
        <div class="form-group text-center mb-0">
            <button class="btn bg-gradient-info w-100 w-md-auto mb-1 mb-md-0" wire:loading.attr="disabled">
                <span>
                    <div wire:loading.inline wire:target="onDnsRecordsChecker">
                        <x-loading />
                    </div>
                    <span wire:target="onDnsRecordsChecker">{{ __('Check') }}</span>
                </span>
            </button>
