...
<body>
  <header class="wrap nav">
    ...
    <nav class="navlinks"><a href="{{ route('tools.directory') }}">All tools</a><a href="#workflows">How it works</a><a href="{{ route('public.resources') }}">Resources</a><a href="{{ url('/blog') }}">Blog</a></nav>
  ...
  <main>
    ...
    <section class="section" id="tools"><div class="wrap">
      <div class="section-head"><div><span class="eyebrow">Start with the essentials</span><h2>Popular SEO tools</h2></div><div><p>Purpose-built checks available directly on fxnseo.com, giving you a useful answer without complicated software.</p><a class="btn" href="{{ route('tools.directory') }}">Browse every tool →</a></div></div>
  ...
  <footer class="footer"><div class="wrap"><span>© {{ date('Y') }} fxnSEOTools</span><span>Tools · Resources · Privacy · Contact</span></div></footer>
